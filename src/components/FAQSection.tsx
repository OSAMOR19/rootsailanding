    ...
    <section id="faq" className="bg-black py-20 md:py-28">
      <div className="mx-auto grid max-w-[1200px] gap-12 px-6 md:grid-cols-2 md:gap-16 lg:gap-20">
        <div className="flex flex-col">
          <h2 className="flex flex-row items-center justify-start gap-x-2 gap-y-0 font-display text-left md:text-3xl font-bold uppercase leading-[1.05] tracking-[0.03em] md:items-start md:justify-start sm:flex-col sm:gap-x-0 sm:gap-y-2">
          ...
          <p className="mt-6 max-w-md text-sm leading-relaxed text-zinc-400 [font-family:ui-sans-serif,system-ui,sans-serif] md:text-base">
